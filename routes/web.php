...
use App\Livewire\Client\Messages\ChatComponent;
...
use App\Livewire\Seller\Messages\ChatComponent as SellerChatComponent;
use App\Livewire\Seller\Messages\MessageComponent as SellerMessageComponent;
...
Route::middleware('auth')->group(function () {
    Route::prefix('client/')->name('client.')->middleware('role:client')->group(function () {
        ...
        // Chat Routes
        Route::get('chats', ChatComponent::class)->name('chats');
        Route::get('chats/messages/{chat_id}', MessageComponent::class)->name('chatMessages');
    ...
    Route::prefix('seller/')->name('seller.')->middleware('role:seller')->group(function () {
        ...
        Route::get('seller/chats', SellerChatComponent::class)->name('sellerChats');
        Route::get('seller/messages/{chat_id}', SellerMessageComponent::class)->name('sellerMessages');
