    ...
    <section class="client_profile_wrapper client_settings_wrapper mt-12">
        <div class="horizontal-m-w">
            <div class="account_area">
                ...
                <a href="{{ route('client.settingsNotification') }}" class="account_item_grid">
                ...
                <a href="{{ route('client.settingsSupport') }}" class="account_item_grid">
                ...
                <a href="{{ route('client.settingsPassword') }}" class="account_item_grid">
