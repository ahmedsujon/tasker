<div>
    <section class="forget_password_wrapper">
        <form wire:submit.prevent='updatePassword' class="form_area h-full-screen space-between horizontal-m-w pt-12">
            <div class="w-100">
                ...
                <div class="input_row mt-24">
                    ...
                    <div class="password_area">
                        <input type="password" wire:model.blur='old_password' placeholder="Enter old password"
                            class="input_field" />
                ...
                <div class="input_row">
                    ...
                    <div class="password_area">
                        <input type="password" wire:model.blur='password' placeholder="Enter new password"
                            class="input_field" />
                        <div class="password_btn_area">
                            <button type="button" class="eye_open passwordVisibilityBtn">
                                <img src="{{ asset('assets/app/icons/eye.svg') }}" alt="eye icon" />
                ...
                <div class="input_row">
                    ...
                    <div class="password_area">
                        <input type="password" wire:model.blur='confirm_password'
                            placeholder="Enter your confirm password" class="input_field" />
                        <div class="password_btn_area">
                            <button type="button" class="eye_open passwordVisibilityBtn">
                                <img src="{{ asset('assets/app/icons/eye.svg') }}" alt="eye icon" />
                            </button>
            ...
            <div class="w-100">
                <button type="submit" class="login_btn">{!! loadingStateWithText('updatePassword', 'Save') !!}</button>
            </div>
        </form>
    </section>
</div>
