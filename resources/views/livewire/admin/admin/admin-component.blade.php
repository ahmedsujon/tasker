                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-footer bg-transparent">
                            {{ $admins->links('livewire.admin-pagination') }}
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" type="password" wire:model.blur="password"
                                            placeholder="Enter new password" wire:model.blur='password'>
                                        @error('password')
                                            <p class="text-danger" style="font-size: 11.5px;">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <label for="example-number-input" class="col-form-label">Role</label>
