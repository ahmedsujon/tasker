<div>
    ...
    <div class="tab-content mt-24" id="pills-tabContent" style="margin-bottom: 90px;">
            ...
            <section class="bids_wrapper">
                @foreach ($saved_jobs as $job)
                    <div class="bids_card">
                        <a href="{{ route('seller.sellerJobsDetails', ['id' => $job->id]) }}"
                            class="bids_title text-line-clamp2">
                            {{ getSavedJobByID($job->job_id)->title }}
                        </a>
                        <div class="bid_inf_grid">
                            <div>
                                <div class="d-flex align-items-center gap-1">
                                ...
                                <h3>{{ getSavedJobByID($job->job_id)->budget }} SAR</h3>
                            </div>
                            <div>
                                <div class="d-flex align-items-center gap-1">
                                    <img src="{{ asset('assets/app/icons/time-05.svg') }}" alt="time icon"
                            ...
                            <div>
                                <div class="d-flex align-items-cente gap-1r">
                                    <img src="{{ asset('assets/app/icons/location-03.svg') }}" alt="location icon"
                                        class="bid_icon" />
                                    <h4>{{ getSavedJobByID($job->job_id)->location }}</h4>
                                </div>
                            </div>
                        </div>
                        {{-- <ul class="bid_tag_list d-flex align-items-center flex-wrap">
            ...
            <section class="bids_wrapper">
                @foreach ($active_jobs as $job)
                    <div class="bids_card">
                        <a href="{{ route('seller.sellerJobsDetails', ['id' => $job->id]) }}"
                            class="bids_title text-line-clamp2">
                            {{ getActiveJobByID($job->job_id)->title }}
                        </a>
                        <div class="bid_inf_grid">
                            <div>
                                <div class="d-flex align-items-center gap-1">
                                ...
                                <h3>{{ getActiveJobByID($job->job_id)->budget }} SAR</h3>
                            </div>
                            <div>
                                <div class="d-flex align-items-center gap-1">
                                    <img src="{{ asset('assets/app/icons/time-05.svg') }}" alt="time icon"
                            ...
                            <div>
                                <div class="d-flex align-items-cente gap-1r">
                                    <img src="{{ asset('assets/app/icons/location-03.svg') }}" alt="location icon"
                                        class="bid_icon" />
                                    <h4>{{ getActiveJobByID($job->job_id)->location }}</h4>
                                </div>
                            </div>
                        </div>
                        {{-- <ul class="bid_tag_list d-flex align-items-center flex-wrap">
